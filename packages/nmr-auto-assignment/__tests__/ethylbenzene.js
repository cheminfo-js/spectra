...
describe('ssss.', function () {
    ...
    var peakPicking = [
        {"from":7.25629,"to":7.31871,"integral":1.96836,"signal":[{"nbAtoms":0,"diaID":[],"multiplicity":"m","kind":"","remark":"","delta":7.28271}],"signalID":"1H_0"},
        {"from":7.15091,"to":7.22304,"integral":2.76568,"signal":[{"nbAtoms":0,"diaID":[],"multiplicity":"m","kind":"","remark":"","delta":7.20152}],"signalID":"1H_1"},
        {"from":2.56504,"to":2.64283,"integral":1.97669,"signal":[{"nbAtoms":0,"diaID":[],"multiplicity":"q","kind":"","remark":"","j":[{"coupling":7.65449122379232,"multiplicity":"q"}],"delta":2.60393}],"signalID":"1H_2"},
        {"from":1.16673,"to":1.2144,"integral":2.79207,"signal":[{"nbAtoms":0,"diaID":[],"multiplicity":"t","kind":"","remark":"","j":[{"coupling":7.654491223786863,"multiplicity":"t"}],"delta":1.19057}],"signalID":"1H_3"}];
    ...
    it('condensed for ethylbenzene', async function () {
        var result = await autoassigner({general: {molfile: molfile},
    ...
    it('condensed for ethylbenzene from molfile', async function () {
